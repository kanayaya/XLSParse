...
public class XLSTableParser {
     ...
     * Содержит методы-проверки типа столбца и его значения.<br>
     * <b>ВАЖНО:</b> Условия созданные с помощью пары классов Condition-ConditionLinker<br>
     ...
     * вся цепочка будет считаться завершённой и вернёт соответствующий результат.<br>
     * Соответственно, построение условия должно идти от более "сильных" подусловий к более "слабым"<br>
